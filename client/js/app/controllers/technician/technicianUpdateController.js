app.controller('technicianUpdateController', function($scope, $rootScope, $routeParams, $http, $location) {
	...
	$scope.load = function() {
		...
		$rootScope.helper.ajax('/technician/search.json?' + search
			, ''
			, function(result) {
	...
	$scope.cancel = function() {
		$location.path('/technician/search');
	}
